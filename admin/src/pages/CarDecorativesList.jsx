...
const CarDecorativesList = ({ token }) => {
  ...
  const fetchList = async () => {
    try {
      const res = await axios.get(`${backendUrl}/api/cardecoratives/list`);
  ...
  const removeItem = async (id) => {
    ...
    try {
      const res = await axios.post(
        `${backendUrl}/api/cardecoratives/delete`,
        { id },
        { headers: { token } }
      );
  ...
  const saveEdit = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        `${backendUrl}/api/cardecoratives/update`,
        formData,
        { headers: { token } }
      );
  ...
  return (
    <div className="pl-wrap">
      ...
      <div className="pl-table">
        ...
        {filtered.length === 0 && (
          <div className="pl-empty">No car decoratives found.</div>
        )}
      ...
      {editing && (
        <div className="pl-modal-overlay" onClick={() => setEditing(null)}>
          <div className="pl-modal" onClick={(e) => e.stopPropagation()}>
            <div className="pl-modal__head">Edit Car Decorative</div>
...
export default CarDecorativesList;
