  ...
  return (
    <div className="dc" onClick={handleClick} role="button" tabIndex={0}
      ...
      <div className="dc__media">
        ...
        {/* discount badge */}
        {discount && (
          <span className="dc__badge">{discount}% OFF</span>
        )}

        {/* wishlist heart */}
        <button
          className={`dc__heart${favorited ? " dc__heart--active" : ""}`}
      ...
      <div className="dc__body">
        ...
        <div className="dc__price-row">
          ...
          {originalPrice && (
            <span className="dc__original">₹{Number(originalPrice).toLocaleString("en-IN")}</span>
          )}
        </div>
      </div>
